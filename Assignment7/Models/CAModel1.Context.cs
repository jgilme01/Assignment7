...
namespace Assignment7.Models
{
    ...
    public partial class Community_AssistEntities : DbContext
    {
        ...
        public virtual int usp_AddRequest(string GrantType, string GrantRequestExplanation, string GrantRequestAmount, string personKey)
        {
            var GrantTypeParameter = GrantType != null ?
               new ObjectParameter("GrantType", GrantType) :
               new ObjectParameter("GrantType", typeof(string));

            var GrantRequestExplanationParameter = GrantRequestExplanation != null ?
               new ObjectParameter("GrantRequestExplanation", GrantRequestExplanation) :
               new ObjectParameter("GrantRequestExplanation", typeof(string));

            var GrantRequestAmountParameter = GrantRequestAmount != null ?
                   new ObjectParameter("GrantRequestAmount", GrantRequestAmount) :
                   new ObjectParameter("GrantRequestAmount", typeof(string));

            var personKeyParameter = personKey != null ?
                   new ObjectParameter("personKey", personKey) :
                   new ObjectParameter("personKey", typeof(string));

            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_AddRequest", GrantTypeParameter, GrantRequestExplanationParameter, GrantRequestAmountParameter, personKeyParameter);
        }
}
}
