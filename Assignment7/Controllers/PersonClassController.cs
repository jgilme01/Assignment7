...
{
    public class PersonClassController : Controller
    {
        ...
        PersonLite pl)
        {
            ...
            {
                db.usp_Register(pl.LastName, pl.FirstName, pl.Email, pl.Password, pl.Apartment, pl.Street, pl.City, pl.State, pl.Zipcode, pl.HomePhone, pl.WorkPhone);
